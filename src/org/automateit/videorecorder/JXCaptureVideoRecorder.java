...
/**
 * This video recorder uses JxCapture API to capture video.
 * 
 ...
 * @author mburnside
 */
public class JXCaptureVideoRecorder implements VideoRecorder {
    
    /**
     *  Logging object
     */
    protected static Logger logger = Logger.getLogger(JXCaptureVideoRecorder.class);
    
    /**
     * The 3rd party implementation object that captures the video
     */
    private VideoCapture videoRecorder = null;
    ...
    public void start() throws Exception {
        ...
        try { 
            ...
            videoRecorder = VideoCapture.create();
            
            videoRecorder.setVideoSource(new Desktop());
           
            List<Codec> videoCodecs = videoRecorder.getVideoCodecs();
            
            Codec videoCodec = videoCodecs.get(0);
            
            EncodingParameters encodingParameters = new EncodingParameters(new File(utils.getBaseScreenshotsDirectory() + videoRecorder.getVideoFormat().getId()));
            ...
            videoRecorder.setEncodingParameters(encodingParameters);
        
            videoRecorder.start();
        
        }
        catch(Exception e) { e.printStackTrace(); logger.error("Error while starting the video recording: " + e); throw e; }
