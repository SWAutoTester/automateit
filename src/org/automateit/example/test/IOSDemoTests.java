...
import org.automateit.example.screen.LoginScreen_iOS;

/**
 * This class shows an example of how to use the AutomateIt! framework
 * for testing an iOS demo app.
 * 
 * @author mburnside
 */
public class IOSDemoTests extends MobileAppDemoTestBase {
   
    /**
     * Verify that the app loads correctly on the device and on the correct View Controller.
     *
     * @throws Exception 
     */
    @BeforeTest(description = "Verify that we can display the correct starting page", groups = { "ios" })
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that we can display the correct starting page", groups = { "ios" }, priority = 1)
    public void test_A_Validate_Login_Screen() throws Exception {
      
        try { validateLoginScreen(new LoginScreen_iOS()); }
        catch(Exception e) { throw e; }
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that login fails when not providing a password", groups = { "ios" }, priority = 2)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that the user can close the alert message popup window", groups = { "ios" }, priority = 3)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that login fails when not providing a username", groups = { "ios" }, priority = 4)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that login fails when providing a valid username and incorrect password", groups = { "ios" }, priority = 5)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that login fails when providing a valid username and incorrect password", groups = { "ios" }, priority = 6)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that login succeeds when providing a valid username and valid password", groups = { "ios" }, priority = 7)
     ...
     * @throws Exception 
     */
    @Test(description = "Verify that the user can close the app in on the device", groups = { "ios" }, priority = 100)
