...
/**
 * The Alert Handler interface - Zabbix. 
 * 
 ...
 * @author mburnside
 */
public class ZabbixAlertHandler extends TestListenerAdapter implements AlertHandler {
    
    /**
     * The location of the email properties file
     */
    public static final String PROPERTIES_FILE = "./conf/zabbix.properties";
     ...
     *  logging object
     */
    private static final Logger logger = Logger.getLogger(ZabbixAlertHandler.class);
    
    /**
     * Default Constructor
     */
    public ZabbixAlertHandler() { loadProperties(); }
