...
public class SendEmailThread extends SendMessageThreadBase {
    ...
    public void run() {
        ...
        try {
            ...
            mimeMessage.setSubject("QA: " + CommonProperties.getInstance().getTargetEnvironment() + ": " + CommonProperties.getInstance().getProductId() + ": " + getCompoundKeyName() + " " + props.getProperty("mail.subject"));  
         
            if(result != null) mimeMessage.setText("Test Failed: " + getCompoundKeyName() + "\n\n" + "--------------" + "\n\n" + result.getThrowable());  
